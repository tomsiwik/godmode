      ...
      {options.map((option, i) => {
        ...
        return (
          <Link
            ...
            href={url}
            className={cn(
              'inline-flex h-full border-b-2 border-transparent transition-colors items-center font-medium gap-2 text-fd-muted-foreground text-sm text-nowrap hover:text-fd-accent-foreground',
