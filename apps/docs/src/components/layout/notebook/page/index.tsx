...
export function DocsPage({
  ...
  if (tocEnabled || tocPopoverEnabled) {
    wrapper = (children) => (
      <TOCProvider single={tocOptions.single} toc={toc} rootMargin="-128px 0px 0px 0px">
        {children}
      </TOCProvider>
    );
  }
  ...
  return wrapper(
    <>
      ...
      <article
        ...
        data-full={full}
        className={cn(
          'flex flex-col [grid-area:main] px-4 py-6 gap-4 md:px-6 md:pt-8 xl:pt-14 *:max-w-4xl',
          full && '*:max-w-7xl',
          className,
        )}
      >
